 ...
 */
public abstract class AbsSwipeViewTouchListener<T> implements View.OnTouchListener {
    ...
    // Fixed properties
    final SwipeView<T> swipeListView;
     ...
     */
    public AbsSwipeViewTouchListener(SwipeView<T> swipeListView, int swipeFrontView, int swipeBackView) {
    ...
    public void resetItems() {
        if (swipeListView.getMainAdapter() != null) {
            int count = getCount();
        ...
        switch (MotionEventCompat.getActionMasked(motionEvent)) {
            ...
            case MotionEvent.ACTION_UP: {
                if (velocityTracker == null || !swiping || downPosition == ListView.INVALID_POSITION) {
                    return view.onTouchEvent(motionEvent); //break;
                }
...
//                }
    ...
    protected abstract boolean isSwipeAllowed(int childPosition);
